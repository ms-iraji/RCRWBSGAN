...
def getNetwork(args, num_classes, ema= False):
    ...
    if args.arch in ['cnn13','WRN28_2']:
        ...
        #net = ResNet18()
        net=DenseNet121(out_size=2, mode='U-Ones', drop_rate=0.2)                       
...
##############                                                
                        ...
                        classes = ('Non-cancerous lesion(Benign)', 'cancerous lesion(Malignant)', )
                        ...
                        plt.savefig(exp_dir+'/output.png')
                        plt.savefig(exp_dir+'/output.pdf')
...
###
                        ...
                        label_names = {0: 'Non-cancerous lesion(Benign)', 1: 'cancerous lesion(Malignant)'}  # Modify with your actual class names
                        ...
                        ax.legend(loc='best')
                        plt.title("t-SNE Visualization of Features for  ISIC-2020 unlabeled images using %03d" % (args.num_labeled*num_classes)+" labeled images, additional unlabeled images, and informative fake images")
...
####
                        ...
                        df_fake[last_col_name] = 2  # Overwrite all values in this column with 3
                        ...
                        label_names = {0: 'Non-cancerous lesion(Benign)', 1: 'cancerous lesion(Malignant)',2:'Generated support vectors '}  # Modify with your actual class names
                        unique_labels = np.unique(y)
                        ...
                        ax.legend(loc='best')
                        plt.title("t-SNE Visualization of Features for  ISIC-2020 generated support vectors and unlabeled images using %03d" % (args.num_labeled*num_classes)+" labeled images, additional unlabeled images, and informative fake images")
                        plt.xlabel("t-SNE Component 1")
                        plt.ylabel("t-SNE Component 2")
                        #plt.show()
...
###
                        ...
                        ax.legend(loc='best')
                        plt.title("t-SNE Visualization of Features for  ISIC-2020 labeled images using %03d" % (args.num_labeled*num_classes)+" labeled images, additional unlabeled images, and informative fake images")
                        plt.xlabel("t-SNE Component 1")
                        plt.ylabel("t-SNE Component 2")
                        #plt.show()
...
###
                        ...
                        ax.legend(loc='best')
                        plt.title("t-SNE Visualization of Features for  ISIC-2020 generated support vectors and labeled images using %03d" % (args.num_labeled*num_classes)+" labeled images, additional unlabeled images, and informative fake images")
                        plt.xlabel("t-SNE Component 1")
                        plt.ylabel("t-SNE Component 2")
                        #plt.show()
...
##############
                        ...
                        ax.legend(loc='best')
                        plt.title("t-SNE Visualization of Features for  ISIC-2020 test images using %03d" % (args.num_labeled*num_classes)+" labeled images, additional unlabeled images, and informative fake images")
                        plt.xlabel("t-SNE Component 1")
                        plt.ylabel("t-SNE Component 2")
                        #plt.show()
